function traj = ute_trajectory_girf(kdim,goldenangle,girf_k)
% Compute k-space coordinates [-1;1] for ute radial acquisitions from the GIRF
...
girf_k(:,1)=girf_k(:,1)*2*kdim(1);
girf_k(:,2)=girf_k(:,2)*2*kdim(1);
girf_k(:,3)=girf_k(:,3)*2;
