function [x,cost] = nlcg_multiband(x0,params)
% 
...
w=params.PH*(params.W*(params.N*(params.S'*(x+t*dx))))-params.y;
...
L2Grad=2.*(params.S*(params.N'*(params.W*(params.PH'*(params.PH*(params.W*(params.N*(params.S'*x)))-params.y)))));

% TV part
l1smooth=1e-15;
w=reshape(params.TV*x(:),[params.idim(1:3) 1 params.idim(5:end)]);
