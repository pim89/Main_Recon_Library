function [x,cost] = nlcg_gmd(x0,params)
% 
...
w=params.W*(params.N*(params.S'*(params.U*repmat((x+t*dx),[1 1 1 1 params.kdim(5)]))))-params.y;
L2obj=w(:)'*w(:);
...
% L2-norm part
L2Grad=2.*sum(params.U'*(params.S*(params.N'*(params.W*((params.W*(params.N*(params.S'*(params.U*repmat(x,[1 1 1 1 params.kdim(5)])))))-params.y)))),5);
