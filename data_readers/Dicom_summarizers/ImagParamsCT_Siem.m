function [Dim,Vox]=ImagParamsCT_Siem( pat,ext )
...
fprintf(['Acq date: %s @ %s ; PatiendID: %s (%s)\n',...
    ...
    dcmCT.Manufacturer,dcmCT.ManufacturerModelName,...
    dcmCT.Modality,...
    ...
    %dcmCT.StudyDescription 'CTDIvol = %0.3f
%,    dcmCT.ScanOptions%     dcmCT.AcquisitionDuration);
