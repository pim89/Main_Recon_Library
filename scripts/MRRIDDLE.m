function [img,seq] = MRRIDDLE(datapath,outpath,dt)
...
traj=MR.Parameter.Encoding.KyOversampling*radial_trajectory(kdim(1:2),1);
...
m.mrriddle=zeros(MR.Parameter.Encoding.XReconRes,MR.Parameter.Encoding.YReconRes,MR.Parameter.Encoding.ZReconRes,numel(recon_time)+1,'single');
